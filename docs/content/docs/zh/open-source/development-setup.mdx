...
请参考我们的 [AGENTS.md](https://github.com/whitelonng/Talkcody/blob/main/AGENTS.md) 了解代码规范和最佳实践。

## 下一步

- [架构设计](/docs/open-source/architecture) - 理解代码库
- [GitHub Issues](https://github.com/whitelonng/Talkcody/issues) - 报告 Bug 或请求功能
