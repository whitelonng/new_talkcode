...
Currently supported languages are pre-configured. If you need support for other languages, you can submit a feature request on [GitHub Issues](https://github.com/whitelonng/new_talkcode/issues).
