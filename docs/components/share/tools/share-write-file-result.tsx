// docs/components/share/tools/share-write-file-result.tsx
// WriteFile tool result renderer for share page

import { FilePlus } from 'lucide-react';
import type { WriteFileOutput } from '@/types/share-tools';
import { ShareMarkdown } from '../share-markdown';

interface ShareWriteFileResultProps {
  output: WriteFileOutput;
}

export function ShareWriteFileResult({ output }: ShareWriteFileResultProps) {
