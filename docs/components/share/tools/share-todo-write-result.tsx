// docs/components/share/tools/share-todo-write-result.tsx
// TodoWrite tool result renderer for share page
// Reused from desktop version with minimal changes

import { CheckCircle2, Circle, Clock, ListTodo } from 'lucide-react';
import type { TodoWriteOutput } from '@/types/share-tools';

interface ShareTodoWriteResultProps {
  output: TodoWriteOutput;
}

export function ShareTodoWriteResult({ output }: ShareTodoWriteResultProps) {
  const { todos } = output;
