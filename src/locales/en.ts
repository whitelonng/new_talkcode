...
const en: LocaleDefinition = {
  ...
  Chat: {
    ...
    files: {
      ...
      filePathInserted: (count) => `${count} file path(s) inserted`,
    },
    planMode: {
      label: 'Plan Mode',
      title: 'Plan Mode',
  ...
  Settings: {
    ...
    customModelsDialog: {
      ...
      editDescription: 'Modify model information and capabilities.',
      modelName: 'Model Name',
      modelNamePlaceholder: 'Enter display name',
      ...
      saveChanges: 'Save Changes',
      modelUpdated: 'Custom model updated',
    ...
    theme: {
      ...
      retromaGroupLabel: 'Retroma Theme',
      options: {
        light: 'Light',
        dark: 'Dark',
        system: 'System',
        ...
        retromaLight: 'Retroma Light',
        retromaDark: 'Retroma Dark',
      },
      descriptions: {
        ...
        retromaLight: 'Use a parchment-inspired light theme with bookish typography',
        retromaDark: 'Use a warm obsidian dark theme with Retroma reading accents',
      },
  ...
  GitPanel: {
    ...
    pullSuccess: 'Changes pulled successfully',
    stageSuccess: 'Files staged successfully',
    unstageSuccess: 'Files unstaged successfully',
    ...
    remoteAdded: 'Remote added successfully',
    remoteRemoved: 'Remote removed successfully',
    addRemoteFailed: 'Failed to add remote',
    removeRemoteFailed: 'Failed to remove remote',
    confirmRemoveRemote: 'Are you sure you want to remove this remote?',
    noRemotes: 'No remotes configured',
    noRemoteHint: 'No remote — click to add',
    // Commit log
...
Note: ChatGPT Plus/Pro subscription is separate from API access.`,
  ...
  FileTree: {
    ...
    contextMenu: {
      ...
      refresh: 'Refresh',
      referenceToChat: 'Reference in Chat',
    },
    placeholder: {
