  ...
  Settings: {
    ...
    theme: {
      ...
      options: {
        ...
        appleLight: 'Apple 浅色',
        appleDark: 'Apple 深色',
        retromaLight: 'Retroma 浅色',
        retromaDark: 'Retroma 深色',
      },
      descriptions: {
        light: '保留当前默认浅色风格',
        dark: '保留当前默认深色风格',
        ...
        retromaLight: '使用 Retroma 书卷风格浅色界面',
        retromaDark: '使用 Retroma 书卷风格深色界面',
      },
      currentTheme: '当前主题',
      switchTo: '切换到',
    },
